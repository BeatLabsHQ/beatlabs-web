...
- Keep the MacPaw grammar: 10px/20px corners, no shadows on panels (only under icons), Fixel weights 500/600 for headings, black buttons with the icon on the right, centred section heads, real assets only. No hero-scale type, no marquees, no outlined words.
